...
function getWinners(getFinals, data) {
    let moreFinals = getFinals(data);
    let winners = [];
    moreFinals.forEach(function(item){
...
function getWinnersByYear(getYears, getWinners){
    ...
    return getYears.map(function(item, index){
...
// We want to reduce the total number of goals per match, 
//Average the total(reduced) number
const goals = data.reduce(function(acc, item){
